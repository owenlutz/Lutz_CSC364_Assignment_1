...
LISTEN_PORT = 8005
FORWARDING_TABLE_PATH = "router_5_table.csv"

OUTPUT_DIR = "./output"
RECEIVED_LOG = os.path.join(OUTPUT_DIR, "received_by_router_5.txt")
SENT_LOG = os.path.join(OUTPUT_DIR, "sent_by_router_5.txt")
DISCARDED_LOG = os.path.join(OUTPUT_DIR, "discarded_by_router_5.txt")
OUT_LOG = os.path.join(OUTPUT_DIR, "out_router_5.txt")
