...
LISTEN_PORT = 8002
FORWARDING_TABLE_PATH = "router_2_table.csv"

OUTPUT_DIR = "./output"
RECEIVED_LOG = os.path.join(OUTPUT_DIR, "received_by_router_2.txt")
SENT_LOG = os.path.join(OUTPUT_DIR, "sent_by_router_2.txt")
DISCARDED_LOG = os.path.join(OUTPUT_DIR, "discarded_by_router_2.txt")
OUT_LOG = os.path.join(OUTPUT_DIR, "out_router_2.txt")
